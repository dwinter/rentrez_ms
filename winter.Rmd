...
function's help page) to discover scientific papers that were published in 2017 
...
journals that these papers appeared in can be isolated and the 
resulting character vector can be used to identify the PubMed-indexed
journals that have published the most R packages this year.
...
documentation on each of the EUtils endpoints with detailed workflows
